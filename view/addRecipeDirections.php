...
/******************************************************************************************
*******************************************************************************************
** Name: addRecipeDirections.php													   ****
** Description: Provides interface for uploading directions for a desired recipe       ****	   			   														
** Author: Rhys Hall																   ****
...
<html>
	...
	<body onFocus="parentDisable();" onclick="parentDisable();">
		...
		<div id="container">
			...
			<div id="bar">
				<div class="progress">
					<div id="blue-bar" class="progress-bar progress-bar-info progress-bar-striped active" role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100">
